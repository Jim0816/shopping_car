...
public class UserRegist extends JFrame implements ActionListener
{
	//定义组件
	JLayeredPane layeredPane;
	private JLabel j1,j2,j3,j4,j5,j6,j8;
	...
	public void actionPerformed(ActionEvent e) 
	{
		if(e.getSource()==btn1)
		{
			...
			{
				JOptionPane.showMessageDialog(null, "请输入您的全部信息！","用户注册提示",JOptionPane.WARNING_MESSAGE);
			}
			else
			{
				this.dispose();
